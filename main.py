...
if __name__ == '__main__':
    ...
    print("\n" + "="*80)
    print("🎯 QUICK REFERENCE FOR MANIPULATION:")
    print("="*80)
    print("• Use soup.find_all('text') to get all text elements")
    print("• Use soup.find_all('g') to get all groups/layers")
    print("• Use soup.find(id='specific_id') to get element by ID")
    print("• Use soup.find_all('rect') to get all rectangles")
    print("• Use soup.find_all(['circle', 'ellipse']) to get circles")
    print("• Element attributes: element.get('attribute_name')")
    print("• Element text: element.get_text(strip=True)")
    print("• Modify attributes: element['attribute'] = 'new_value'")
    print("• Add new elements: parent.append(soup.new_tag('tagname'))")
